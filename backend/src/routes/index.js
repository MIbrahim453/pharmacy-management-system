...
import paymentRoutes from "../modules/admin/payments/payment.routes.js";
...
router.use(`${API_PREFIX}/admin-dashboard`, adminDashboardRoutes);
...
router.use(`${API_PREFIX}/admin-payments`, paymentRoutes);
